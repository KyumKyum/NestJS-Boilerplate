...
class UserService {
    ...
    ): Promise<Result<UserDto, DataCreateFailedException | UniqueKeyConstraintsViolation>> {
        try {
            ...
            if (e instanceof QueryFailedError && e.driverError.code == '23505') {
                return ResultStatus.err(new UniqueKeyConstraintsViolation(`The user is already exists!`));
            }
